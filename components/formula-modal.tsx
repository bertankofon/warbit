...
import FormulaGame from "./formula-game"
...
export default function FormulaModal({ battle, onClose }: FormulaModalProps) {
  ...
  return (
    <Dialog open={true} onOpenChange={onClose}>
      <DialogContent className="bg-gray-900 text-white border-yellow-500 max-w-2xl">
        <DialogHeader>
          <DialogTitle className="text-yellow-400 pixel-font">FORMULA RACER BATTLE</DialogTitle>
          <DialogDescription>Dodge obstacles and get the highest score to win!</DialogDescription>
        </DialogHeader>
        ...
        <div className="py-4 space-y-6">
          ...
          {gamePhase === "playing" && myTurn && (
            <>
              ...
              <FormulaGame onGameOver={handleGameOver} autoStart={false} elementType={getMyElementType()} />
              <div className="text-center text-xs text-gray-400 pixel-font">USE LEFT/RIGHT ARROWS TO MOVE</div>
            </>
          )}
